...
std::vector<float> ecg_data;    // Stores the ECG data read from file (not used for calculations)
...
int main() {
    ...
    // simulated ADS1115 parameters (allows shorter readings for some debugging)
